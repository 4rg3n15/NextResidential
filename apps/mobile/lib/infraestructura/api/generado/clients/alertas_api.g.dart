...
class _AlertasApi implements AlertasApi {
  _AlertasApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<AlertaExpuestaDto>> alertasControllerAbiertas({
    ...
    late List<AlertaExpuestaDto> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
  ...
  Future<AlertaExpuestaDto> alertasControllerAtender({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AlertaExpuestaDto>(
    ...
    late AlertaExpuestaDto _value;
    try {
      _value = AlertaExpuestaDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AlertaExpuestaDto> alertasControllerResolver({
    required String id,
    required String alertaId,
    required NotasDeAlertaDto body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};

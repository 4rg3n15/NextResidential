...
class _BiometriaApi implements BiometriaApi {
  _BiometriaApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<void> biometriaControllerEjecutarBarrido({required String id}) async {
  ...
  Future<void> biometriaControllerSincronizarPlantilla({
    ...
    required SincronizarPlantillaDto body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};

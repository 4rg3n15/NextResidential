...
class _DispositivosApi implements DispositivosApi {
  _DispositivosApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<PendientesDto> dispositivosControllerPendientes({
    ...
    final _options = _setStreamType<PendientesDto>(
    ...
    late PendientesDto _value;
    try {
      _value = PendientesDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<ResultadoDeOperacionDto> dispositivosControllerConfigurar({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ResultadoDeOperacionDto>(
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late ResultadoDeOperacionDto _value;
    try {
      _value = ResultadoDeOperacionDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }

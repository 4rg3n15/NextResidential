...
@JsonEnum()
enum EventoRegistradoDtoMotivo {
  ...
  const EventoRegistradoDtoMotivo(this.json);

  factory EventoRegistradoDtoMotivo.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<EventoRegistradoDtoMotivo> get $valuesDefined => values.where((value) => value != $unknown).toList();
}

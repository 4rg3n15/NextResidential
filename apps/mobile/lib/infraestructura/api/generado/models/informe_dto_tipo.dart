...
enum InformeDtoTipo {
  ...
  const InformeDtoTipo(this.json);

  factory InformeDtoTipo.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<InformeDtoTipo> get $valuesDefined => values.where((value) => value != $unknown).toList();
}

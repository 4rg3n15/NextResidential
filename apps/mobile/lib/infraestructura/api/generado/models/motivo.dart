...
enum Motivo {
  ...
  const Motivo(this.json);

  factory Motivo.fromJson(String json) => values.firstWhere(
        (e) => e.json == json,
        orElse: () => $unknown,
      );
  ...
  static List<Motivo> get $valuesDefined => values.where((value) => value != $unknown).toList();
}

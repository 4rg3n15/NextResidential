...
| **Bloqueos activos**           | **BE-02 · la ETAPA 15 espera el equipo**: sin acceso físico a los aparatos no hay hitos técnicos ni KPI de latencia · **BE-01 · SMTP y URLs de redirección** deja de bloquear: D9 descarta el SMTP y D4 pone el restablecimiento en manos de una persona (P-18 resuelto); el ciclo por correo sigue construido y sin verificar (AR-04)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Defectos abiertos**          | **H-15I-05** (la persistencia guarda la franja de un patrón semanal en hora local y la relee como UTC; reportado con parche, no afecta a los 16 escenarios; la recurrente desde la app falla cerrada mientras tanto, H-15I-06) · **D-140** (bloqueos de acceso en memoria, 15-E) · **D-137** (actor de ingesta: corregido con la 0035, S-44) · **D-139** (alertas, órdenes y auditoría en memoria: corregido con la 0036) · **D-138** (`guardia.controller.ts` supera las 300 líneas de §2.3 desde la A4; el video fue a un controlador aparte, la partición del resto queda para la 16) · **D-101** (roja intermitente de `@ncr/api`: no reapareció en la 15-D; NO cerrada), **D-133** (control contra claves ajenas a tablas append-only, 15-D) y **D-29** (canal de tiempo real por proceso) · **D-25, D-130, D-131 y D-132 CERRADOS en la 15-D** · **D-78 y D-34 CERRADAS en la 14** · más **H-13-25**, abierto a propósito a la espera de firma |
| **Contradicciones abiertas**   | **1** (**28** registradas, 27 resueltas): **C-37**, reportada sin resolver —D8 pone la consola en Netlify y el SSE y el audio de portería y guardia no caben en sus funciones— → P-20; no bloquea BE-02 porque en sitio la consola corre en el portátil · **C-35 a C-37** añadidas en la 15-I; **C-32 a C-34** en la 15-H; C-28 a C-31 en la 15-D; C-28 revoca C-11                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Decisiones pendientes**      | 7 abiertas — **P-19** (viviendas anteriores a la 15-I sin declaración de ocupantes) y **P-20** (flujos largos de la consola en Netlify, C-37) añadidas en la 15-I, ninguna bloquea BE-02 · **P-08** (en parte), **P-09**, **P-15**, **P-16**, **P-17** y **P-18** RESUELTAS en la 15-I por D2–D9 · **P-02 RESUELTA** (umbral de confianza: 80 en la escala 0–100 del evento ANPR) y **P-06 SUSTITUIDA** (el margen de latido deja de ser configurable) en la ronda 15-B · más **5 aceptaciones de riesgo redactadas y sin firmar** (AR-01 a AR-04 y el riesgo residual de `H-15B-1`)                                                                                                                                                                                                                                                                                                                                                                 |
| **Supuestos vigentes**         | 38 — **S-52 a S-61** añadidos en la 15-I · **S-48 a S-51** añadidos en la 15-H (llave del código de patrullaje, quinto intento, cifras de los límites, temporal escrita) · **S-39 a S-47** añadidos en la 15-E (actor de ingesta propio, enlace del titular, forma de la URL RTSP S-46 y API de go2rtc S-47, por confirmar en sitio); S-38 sigue pendiente de ratificar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Extensiones al contrato**    | 3 — E-01 `FUERA_DE_HORARIO`, aprobada · **E-02 · Bloque B sesión 1 (identidad por usuario y portería)**, aprobada el 2026-09-25 · **E-03 · Bloque B sesión 2 (residentes y app, D1–D9)**, aprobada el 2026-09-26                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| **S-24**                                    | Se anotó que «se cierra con el tablero de reglas de la ETAPA 14». El alcance de la 14 **no incluye ningún tablero de reglas**: incluye observabilidad, CI/CD, PWA y escritorio       | ETAPA 16     |
...
| **H-15I-05**        | La persistencia guarda la franja de un patrón semanal en hora local y la relee como UTC                                            | **Reportado con parche** · no toca los 16      |
| **H-15I-06**        | La recurrente desde la app habría abierto a la hora equivocada por H-15I-05                                                        | Corregido · falla cerrada con RN-22            |
...
| **A6** · app móvil sin `localhost` por omisión, ATS sólo en depuración               | Un teléfono con `localhost` habla consigo mismo; la app arrancaba y fallaba sin decir por qué                                                                                             |

...
| **Defectos abiertos**          | **D-140** (bloqueos de acceso en memoria, 15-E) · **D-137** (actor de ingesta: corregido con la 0035, S-44) · **D-139** (alertas, órdenes y auditoría en memoria: corregido con la 0036) · **D-138** (`guardia.controller.ts` supera las 300 líneas de §2.3 desde la A4; el video fue a un controlador aparte, la partición del resto queda para la 16) · **D-101** (roja intermitente de `@ncr/api`: no reapareció en la 15-D; NO cerrada), **D-133** (control contra claves ajenas a tablas append-only, 15-D) y **D-29** (canal de tiempo real por proceso) · **D-25, D-130, D-131 y D-132 CERRADOS en la 15-D** · **D-78 y D-34 CERRADAS en la 14** · más **H-13-25**, abierto a propósito a la espera de firma |
| **Contradicciones abiertas**   | Ninguna (**25** registradas, 25 resueltas) — **C-32 a C-34** añadidas en la 15-H; C-28 a C-31 en la 15-D; C-28 revoca C-11                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Decisiones pendientes**      | 11 abiertas — **P-16** (MFA del portero), **P-17** (alcance de los sectores) y **P-18** (recuperación sin SMTP) añadidas en la 15-H, las tres del cliente · **P-02 RESUELTA** (umbral de confianza: 80 en la escala 0–100 del evento ANPR) y **P-06 SUSTITUIDA** (el margen de latido deja de ser configurable) en la ronda 15-B · más **5 aceptaciones de riesgo redactadas y sin firmar** (AR-01 a AR-04 y el riesgo residual de `H-15B-1`)                                                                                                                                                                                                                                                                       |
| **Supuestos vigentes**         | 28 — **S-48 a S-51** añadidos en la 15-H (llave del código de patrullaje, quinto intento, cifras de los límites, temporal escrita) · **S-39 a S-47** añadidos en la 15-E (actor de ingesta propio, enlace del titular, forma de la URL RTSP S-46 y API de go2rtc S-47, por confirmar en sitio); S-38 sigue pendiente de ratificar                                                                                                                                                                                                                                                                                                                                                                                   |
| **Extensiones al contrato**    | 2 — E-01 `FUERA_DE_HORARIO`, aprobada · **E-02 · Bloque B sesión 1 (identidad por usuario y portería)**, aprobada el 2026-09-25                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| 15     | Integración real con hardware Hikvision                       | `etapa-15-integracion-hikvision`       | 14 ✅                               | **BLOQUEADA** · falta el equipo | [ETAPA-15](etapas/ETAPA-15.md) |

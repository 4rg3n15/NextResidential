...
| Alias del emulador Android                                           | `API_URL=http://10.0.2.2:3000` en `apps/mobile/.env.example`                                                                     | Convención del emulador para «la máquina anfitriona»; no es una red del cliente                                                                        |

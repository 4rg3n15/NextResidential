...
| #   | Etapa                                    | Alcance                                                                                                                                                                                                          |
| --- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 15  | **Integración Hikvision** · mitad física | **BLOQUEADA sólo por BE-02**: registrar los tres equipos desde la consola y ejecutar los 16 escenarios (26 filas escenario × canal) desde la consola y la app, con los tres hitos técnicos y los KPI de latencia |
...
El orden de la visita —qué preparar antes de salir de casa y los once pasos en
sitio— está en
[`docs/guias/VALIDACION_HIKVISION_EN_SITIO.md`](docs/guias/VALIDACION_HIKVISION_EN_SITIO.md)
§V; el detalle por equipo, las rutas y los 16 escenarios, en
[`docs/guias/INTEGRACION_HIKVISION.md`](docs/guias/INTEGRACION_HIKVISION.md);
y el ensayo previo en SIMULADO contra base real, fila por fila, en
[`docs/guias/ENSAYO_PREVIO_EN_SITIO.md`](docs/guias/ENSAYO_PREVIO_EN_SITIO.md).
...
dados de alta. **El procedimiento único, con las listas «antes de salir de
casa» y «en sitio», es
...
5. **App del residente**: `flutter run --dart-define=API_URL=http://<IP>:3000`
   ...
   vincular la vivienda y declarar los ocupantes.
...
7. **Guion de sitio** (`scripts/puesta-en-marcha-equipos.mjs --sin-accionar`
   ...
   [`ENSAYO_PREVIO_EN_SITIO.md`](docs/guias/ENSAYO_PREVIO_EN_SITIO.md).
